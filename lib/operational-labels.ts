...
export type AdminLabels = {
  ...
  firstCustomerQuestionnaireComplete: string;
  firstCustomerQuestionnaireCompleteDescription: string;
  ...
  firstCustomerLogoUploaded: string;
  firstCustomerLogoUploadedDescription: string;
  firstCustomerPassportReviewed: string;
  firstCustomerPassportReviewedDescription: string;
  firstCustomerPublicPassportTested: string;
  firstCustomerPublicPassportTestedDescription: string;
  ...
  firstCustomerSupportAvailable: string;
  firstCustomerSupportAvailableDescription: string;
  ...
  firstCustomerAskQuestionnaireComplete: string;
...
export const defaultAdminLabels: AdminLabels = {
  ...
  firstCustomerOnboarding: "Pilot readiness",
  firstCustomerOnboardingSubtitle:
    "Use this checklist before sending the first real supplier workspace to a pilot customer.",
  firstCustomerReady: "Ready for pilot",
  needsOnboarding: "Not ready",
  needsEvidence: "Not ready",
  needsReview: "In preparation",
  firstCustomerNextAction: "Next pilot action",
  firstCustomerInternalNote: "This pilot checklist is internal and not shown to suppliers.",
  ...
  firstCustomerCompanyBasics: "Company profile completed",
  firstCustomerCompanyBasicsDescription: "Derived from the Company Basics questionnaire section and workspace name.",
  firstCustomerQuestionnaireStarted: "Questionnaire started",
  firstCustomerQuestionnaireStartedDescription: "Derived from saved questionnaire answers.",
  firstCustomerQuestionnaireComplete: "Questionnaire complete",
  firstCustomerQuestionnaireCompleteDescription: "Derived from current questionnaire readiness reaching 100%.",
  firstCustomerEvidenceUploaded: "Evidence uploaded",
  ...
  firstCustomerLogoUploaded: "Supplier logo uploaded",
  firstCustomerLogoUploadedDescription: "Recommended brand check derived from organization logo metadata.",
  firstCustomerPassportReviewed: "Passport preview reviewed",
  firstCustomerPassportReviewedDescription: "Derived from available Passport data and questionnaire progress.",
  firstCustomerPublicPassportTested: "Public Passport tested",
  firstCustomerPublicPassportTestedDescription: "Manual check; open the public link before sending it to a pilot customer.",
  ...
  firstCustomerPdfTested: "PDF tested",
  firstCustomerPdfTestedDescription: "Manual QA item; PDF download tracking is not stored.",
  firstCustomerSupportAvailable: "Support channel available",
  firstCustomerSupportAvailableDescription: "Support requests are enabled for supplier workspaces and visible in the admin inbox.",
  ...
  firstCustomerAskCompanyBasics: "Complete the company profile.",
  firstCustomerAskQuestionnaireComplete: "Ask the supplier to complete the questionnaire.",
  firstCustomerAskEvidenceUpload: "Ask supplier to upload evidence documents.",
  firstCustomerAskEvidenceLink: "Link evidence to answers.",
