...
export type DashboardOverviewLabels = {
  ...
  passportReadyTitle: string;
  passportNotReadyTitle: string;
...
export const defaultDashboardOverviewLabels: DashboardOverviewLabels = {
  ...
  passportReadyTitle: "Ready for buyers",
  passportNotReadyTitle: "Not fully ready yet",
  passportReadyDescription:
    "Your profile is ready to share with buyers. Use the public link to share the summary, readiness status and linked evidence availability.",
