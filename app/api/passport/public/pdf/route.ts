...
const publicPdfLabels = {
  ...
  hr: {
    ...
    publicSummary: "VSME-aligned javni sazetak",
    ...
    disclaimer: "Supplier Passport je VSME-aligned sazetak spremnosti dobavljaca temeljen na podacima i metapodacima dokazne dokumentacije koje je dostavio dobavljac. Nije revizijsko misljenje, pravni certifikat niti izvjesce s neovisnim uvjerenjem.",
