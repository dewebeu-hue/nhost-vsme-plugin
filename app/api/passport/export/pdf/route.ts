...
const pdfLabels = {
  ...
  hr: {
    ...
    draft: "VSME-aligned sazetak spremnosti",
    generated: "Generirano",
    vsmeAligned: "VSME-aligned",
    lastPassportUpdate: "Vremenska oznaka Passport podataka",
    notProvided: "Jos nije uneseno",
    reportingYear: "Izvjestajna godina",
    reportingPeriod: "Izvjestajno razdoblje",
    reportingBoundary: "Granica izvjestavanja",
    disclaimerTitle: "Vazna napomena",
    disclaimer:
      "Supplier Passport je VSME-aligned sazetak spremnosti dobavljaca temeljen na podacima i metapodacima dokazne dokumentacije koje je dostavio dobavljac. Nije revizijsko misljenje, pravni certifikat niti izvjesce s neovisnim uvjerenjem.",
    buyerEvidenceNote: "Kupci mogu zasebno zatraziti dokaznu dokumentaciju.",
    company: "Tvrtka",
    ...
    scoreExplanation: "Ovaj rezultat odrazava ispunjene stavke upitnika i dostupne metapodatke dokazne dokumentacije. To je pokazatelj spremnosti, a ne rezultat revizije.",
    answeredQuestions: "Ispunjene stavke",
    linkedEvidence: "Povezani dokazi",
    sectionSummary: "Sazetak sekcija",
    evidenceAvailable: "dokazna dokumentacija dostupna",
    evidenceMissing: "nedostaje dokazna dokumentacija",
    evidenceRecommended: "preporucuje se dokazna dokumentacija",
    evidenceSummary: "Sazetak dokazne dokumentacije",
    noEvidenceSummary: "Sazetak dokazne dokumentacije jos nije dostupan.",
    uploadedDocuments: "Ucitanih dokumenata",
    evidenceMissingCount: "Sekcije s preporucenom dokaznom dokumentacijom koja nedostaje",
    privateEvidenceNote: "Privatni dokazni dokumenti nisu ugradeni u ovaj PDF i nisu dostupni za preuzimanje iz njega, osim ako se zasebno podijele.",
    certificateSummary: "Sazetak isteka certifikata",
    ...
    noExpiringCertificates: "Nisu pronadeni certifikati koji uskoro istjecu prema dostupnim datumima isteka.",
    missingData: "Nedostajuci ili preporuceni podaci",
    recommendedEvidence: "preporucena dokazna dokumentacija",
    ...
    footer: "Generirano",
    footerDisclaimer: "Nacrt spremnosti temeljen na podacima dobavljaca, nije izvjesce s neovisnim uvjerenjem",
    unknownSection: "Nepoznata sekcija",
    limitationsTitle: "Napomene i ogranicenja",
    limitations:
      "Ovaj nacrt temelji se na podacima dostupnima u trenutku generiranja. Kupci mogu zasebno zatraziti dokaznu dokumentaciju. PDF ne ukljucuje privatne URL-ove dokumenata, identifikatore pohrane, osjetljive sirove odgovore ni podatke o korisnicima/clanovima.",
    notStarted: "Nije zapoceto",
    completed: "Dovrseno",
    ...
    sections: {
      ...
      fuel: "Gorivo",
      waste: "Otpad",
      environmental_policies: "Okolisne politike",
      health_safety: "Zdravlje i sigurnost",
      certifications: "Certifikati",
      governance: "Upravljanje",
      supplier_information: "Podaci o dobavljacima",
    },
    sectionMappings: {
      company_basics: "VSME B1 / Identitet dobavljaca",
      employees: "VSME B8-B10",
      energy: "VSME B3",
    ...
    documentCategories: {
      ...
      customer_questionnaire: "Podaci o dobavljacima",
      other: "Ostalo",
      report: "Izvjesca",
      training: "Edukacije",
    },
